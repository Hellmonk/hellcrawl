...

{
    ...
    29, 1100,
    0, 19, MST_ANTIMATTER_ELF, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_WEAPONS_ARMOUR, SIZE_MEDIUM, MON_SHAPE_HUMANOID,
...

{
    ...
    { {AT_HIT, AF_PLAIN, 69}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    18, 2400,
...

{
    ...
    24, 1750,
    40, 6, MST_THE_GIAGGOSTUONO, CE_NOXIOUS, S_LOUD_ROAR,
    I_ANIMAL, HT_LAND, 10, DEFAULT_ENERGY,
    MONUSE_NOTHING, SIZE_GIANT, MON_SHAPE_QUADRUPED_WINGED,
...

{
    ...
    { {AT_BITE, AF_POISON_STRONG, 28}, {AT_BITE, AF_ACID, 27}, {AT_BITE, AF_DRAIN_XP, 26}, AT_NO_ATK },
    15, 940,
...
// minor demons: imps, etc. ('5')
{
    ...
    { {AT_HIT, AF_PLAIN, 4}, AT_NO_ATK, AT_NO_ATK, AT_NO_ATK },
    3, 165,
    3, 17, MST_BLINKER, CE_NOCORPSE, S_SHOUT,
    I_HUMAN, HT_LAND, 12, DEFAULT_ENERGY,
